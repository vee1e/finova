    ...
    <section id="use-cases" className="py-20">
      <div className="container">
        ...
        <div className="max-w-4xl mx-auto bg-white shadow-xl rounded-xl overflow-hidden">
          <div className="bg-gradient-to-r from-emerald-600 to-emerald-400 py-6 px-8">
            <div className="text-white font-mono mb-2">YatraGPT {`>`} Plan a journey from Kolkata (Saltlake) to Manipal University</div>
          </div>
          ...
          <div className="p-8">
            <div className="flex flex-col md:flex-row justify-between mb-8">
              <div>
                ...
                <div className="text-zinc-600">June 15, 8:00 AM</div>
              </div>
              <div className="hidden md:block py-4">
                <div className="w-48 h-0.5 bg-emerald-500 relative">
                  <div className="absolute -top-2 left-0 w-4 h-4 rounded-full bg-emerald-500"></div>
                  <div className="absolute -top-2 right-0 w-4 h-4 rounded-full bg-emerald-500"></div>
                </div>
              </div>
              <div className="mt-4 md:mt-0">
                <div className="text-sm text-zinc-500">DESTINATION</div>
                <div className="font-semibold">Manipal University</div>
                <div className="text-zinc-600">June 15, 6:45 PM</div>
              </div>
            </div>
            
            <div className="relative pl-8 border-l-2 border-dashed border-zinc-200">
              <div className="mb-10 relative">
                <div className="absolute -left-[2.1rem] top-0 w-6 h-6 rounded-full bg-blue-100 flex items-center justify-center">
                ...
                <p className="text-zinc-600 mb-2">8:00 AM - 8:40 AM (40 min)</p>
                <div className="bg-zinc-50 rounded px-4 py-2 inline-block text-sm text-zinc-600">
                  ₹180 · Comfort: Medium
                </div>
              </div>
              
              <div className="mb-10 relative">
                <div className="absolute -left-[2.1rem] top-0 w-6 h-6 rounded-full bg-indigo-100 flex items-center justify-center">
                ...
                <p className="text-zinc-600 mb-2">9:15 AM - 10:05 AM (50 min)</p>
                <div className="bg-zinc-50 rounded px-4 py-2 inline-block text-sm text-zinc-600">
              ...
              <div className="mb-10 relative">
                <div className="absolute -left-[2.1rem] top-0 w-6 h-6 rounded-full bg-sky-100 flex items-center justify-center">
                ...
                <p className="text-zinc-600 mb-2">11:45 AM - 2:15 PM (2h 30m)</p>
                <div className="bg-zinc-50 rounded px-4 py-2 inline-block text-sm text-zinc-600">
              ...
              <div className="mb-10 relative">
                <div className="absolute -left-[2.1rem] top-0 w-6 h-6 rounded-full bg-orange-100 flex items-center justify-center">
                ...
                <p className="text-zinc-600 mb-2">3:00 PM - 5:15 PM (2h 15m)</p>
                <div className="bg-zinc-50 rounded px-4 py-2 inline-block text-sm text-zinc-600">
              ...
              <div className="relative">
                ...
                <p className="text-zinc-600 mb-2">5:30 PM - 6:45 PM (1h 15m)</p>
                <div className="bg-zinc-50 rounded px-4 py-2 inline-block text-sm text-zinc-600">
            ...
            <div className="mt-10 p-4 bg-zinc-50 rounded-lg">
              <div className="flex flex-wrap justify-between gap-4">
                <div>
                  <div className="text-sm text-zinc-500">TOTAL TRAVEL TIME</div>
                ...
                <div>
                  <div className="text-sm text-zinc-500">MODES OF TRANSPORT</div>
                  <div className="font-semibold">5</div>
                </div>
                <div>
                  <div className="text-sm text-zinc-500">COMFORT RATING</div>
